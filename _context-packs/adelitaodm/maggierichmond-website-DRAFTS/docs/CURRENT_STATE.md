...
**Repository:** `adelitaodm/maggierichmond-website-DRAFTS`  
...
- Public on the personal account while the live counterpart is private in the org
- Contains only README.md
- Owned by adelitaodm rather than general-pursuits, unlike the Opportunity Designed and Baddie Pack DRAFTS repos
